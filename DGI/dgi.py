...
class Discriminator(nn.Module):
    ...
    def forward(self, features, summary):
        tmp1 = torch.matmul(features[:1000000], torch.matmul(self.weight, summary))
        tmp2 = torch.matmul(features[1000000:], torch.matmul(self.weight, summary))
        # features = torch.matmul(features, torch.matmul(self.weight, summary))
        features = torch.cat([tmp1,tmp2],dim=0)
        return features
