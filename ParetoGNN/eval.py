...
args.device = 0
args.embedding_path_node = "./checkpoint/experiment_name/tinynft_nodetype_100000_ssnc['p_link']_k-order_reluhid_dim_[256, 128]_optim_adam_inter_dim_0_pred_dim_128_lr_0.0001_decay_1e-05_l2_.pt"
args.embedding_path_link = "./checkpoint/experiment_name/allnft_nodetype_100000_lp['p_link']_k-order_reluhid_dim_[256, 128]_optim_adam_inter_dim_0_pred_dim_128_lr_0.0001_decay_1e-05_l2_.pt"
...
metis_label = torch.load(f'./pretrain_labels/metis_label_tinynft_nodetype.pt', map_location='cpu')
embedding_path_node = args.embedding_path_node
embedding_path_link = args.embedding_path_link

embedding_path_node = embedding_path_link

tvt_edges_file = f'./links/tinynft_nodetype_tvtEdges.pkl'
