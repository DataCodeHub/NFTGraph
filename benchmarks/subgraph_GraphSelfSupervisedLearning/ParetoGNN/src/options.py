...
class Options():
    ...
    def add_ParetoGNN_options(self):
        ...
        self.parser.add_argument('--pretrain_label_dir', required=False, type=str, default='path to pretrain labels')
        self.parser.add_argument('--dataset', type=str, required=False, choices=['wiki_cs', 'co_cs', 'co_phy', 'co_photo', 'co_computer', 'actor', 'chameleon', 'squirrel', 'pubmed', 'cora', 'citeseer', 'arxiv', 'products'], help='dataset')
    ...
    def initialize_parser(self):
        ...
        # self.parser.add_argument('--device',type=int,default=6)
    def parse(self):
