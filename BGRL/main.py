...
def main(args):
    ...
    # )
    tmp_encoder = copy.deepcopy(model.online_encoder).eval()
    representations, labels = compute_representations(tmp_encoder, dataset[0], device)
    torch.save(representations,'./X_bgrl.pt')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--predictor_hidden_size", type=int, default=256)
